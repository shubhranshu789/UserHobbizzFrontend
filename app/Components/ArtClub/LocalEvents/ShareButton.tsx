    ...
    switch (platform) {
      ...
      case "instagram":
        ...
        navigator.clipboard.writeText(shareText).then(() => {
          alert("Event details copied to clipboard! You can now paste it on Instagram.");
        });
  ...
  return (
    <>
      <Button
        variant="outline"
        size="icon"
        className={`${getButtonSize()} bg-white hover:bg-gray-50 border-gray-200 ${className}`}
        onClick={() => setIsPopupOpen(true)}
        title="Share Event"
      >
        <Share2 className={`${getIconSize()} text-gray-600`} />
      </Button>
