                        ...
                        <div className="hidden lg:flex items-center space-x-1">
                            {filteredNavigationItems.slice(0, 6).map((item) => (
                                <Button
                                    ...
                                    onClick={() => {
                                        if (item.id == "Cabinet") {
                                            router.push("/PhotoClub/TechClub/Cabinate/cabinate")
                                        }
                                        if (item.id == "Constitution") {
                                            router.push("/PhotoClub/TechClub/ClubConstitution")
                                        }
                                        if (item.id == "Legacy") {
                                            router.push("/PhotoClub/TechClub/ClubLegacy")
                                        }
                                        if (item.id == "Heritage") {
                                            router.push("/PhotoClub/TechClub/Heritage")
                                        }
                                        if (item.id == "Calendar") {
                                            router.push("/PhotoClub/TechClub/Calendar")
                                        }
                                        if (item.id == "Library") {
                                            // router.push("/Components/ArtClub/Cabinate")
                                        }
                                        if (item.id == "Journal") {
                                            router.push("/PhotoClub/TechClub/ClubJournal")
                                        }
                                        if (item.id == "Domain") {
                                            router.push("/PhotoClub/TechClub/CubDomain")
                                        }
                                        if (item.id == "Chapters") {
                                            router.push("/PhotoClub/TechClub/LocalEvents/Events")
                                        }
                                        if (item.id == "Affairs") {
                                            router.push("/PhotoClub/TechClub/Affairs")
                                        }
                                        if (item.id == "News") {
                                            router.push("/PhotoClub/TechClub/ClubNews")
                                        }
                                        if (item.id == "Fame") {
                                        ...
                                        {filteredNavigationItems.slice(6).map((item) => (
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    if (item.id == "Library") {
                                                        router.push("/PhotoClub/TechClub/Cabinate")
                                                    }
                                                    if (item.id == "Journal") {
                                                        router.push("/PhotoClub/TechClub/ClubJournal")
                                                    }
                                                    ...
                                                    if (item.id == "Fame") {
                                                        router.push("/PhotoClub/TechClub/HallOfFame")
                                                    }
                                                    if (item.id == "Gallery") {
                                                        router.push("/PhotoClub/TechClub/Gallery")
                                                    }
                                                    if (item.id == "Contests") {
                                                        router.push("/PhotoClub/TechClub/Contest")
                                                    }
                                                    if (item.id == "Logout") {
                                                        localStorage.clear()
                                                        // router.push("/Components/Auth/files/SignIn")
