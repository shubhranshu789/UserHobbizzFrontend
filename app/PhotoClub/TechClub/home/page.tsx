...
export default function TechClubHomepage() {
  ...
  //     const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/userjoinPhotoClub/${user._id}`, {
  //       method: "PUT",
  //       headers: {
  ...
  try {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/userjoinPhotoClub/${user._id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const GoToTechAuthPage = () => {
    router.push("/PhotoClub/Auth/files/SignIn")
  }
