...
export const ContinuousCalendar = () => {
  ...
  const [showDeleteModal, setShowDeleteModal] = useState<null | string>(null); // date string like "2025-06-23"
            ...
            >
              ...
              {hasEvent && (
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end px-1 pb-1">
                    <div className="hidden sm:block text-[10px] text-blue-700 font-semibold leading-tight break-words sm:text-xs lg:text-sm max-h-[3.5rem] overflow-hidden">
                      {
                        events.find((e) => {
                          const d = new Date(e.date);
                          return (
                    ...
                    <button
                      ...
                      className="mt-1 self-end rounded-full bg-gray-200 text-gray-700 text-[10px] px-1 py-0.5 hover:bg-gray-300 sm:text-xs"
                    ...
                    {/* <button
                      ...
                      onClick={(e) => {
                        ...
                        setShowDeleteModal(formattedDate);
                      }}
                      className="mt-1 self-end rounded-full bg-gray-200 text-gray-700 text-[10px] px-1 py-0.5 hover:bg-gray-300 sm:text-xs"
                      title="Delete Event"
                    >
                  ...
                  {openEventDay?.day === day &&
                    openEventDay?.month === month && (
                      <div
                        className={`absolute z-50 bottom-10 mx-auto w-40 rounded bg-white p-2 text-sm shadow-lg border
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
    <div className="bg-white p-6 rounded-lg shadow-lg w-80 space-y-4">
      ...
      <p>Are you sure you want to delete the event(s) for <strong>{showDeleteModal}</strong>?</p>
      <div className="flex justify-end gap-2">
        <button
        ...
        <button
          onClick={async () => {
            try {
              ...
              if (res.ok) {
                setEvents(events.filter(e => e.date !== showDeleteModal));
